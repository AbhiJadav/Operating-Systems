...
public class Face extends javax.swing.JFrame {
    ...
    public void delay ()
    {
        ...
        try {
            Thread.sleep(1000 * num); // 150 is here by try and error
        } 
    ...
    private void initComponents() {
        ...
        //AlgorithmsMenu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FCFS", "SJF", "STRF", "RR", "Priority1", "Priority2" , "IRRVQ","AAIRR","TARR","SelfScheduling","OptimizedRR","ANRR","MBRR","ARRSTC"}));
        AlgorithmsMenu.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"RR","IRRVQ","AAIRR","TARR","SelfScheduling","OptimizedRR","ANRR","MBRR","ARRSTC","IRR","IARR"}));
        ...
        simSpeed.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0","1","2", "3", "4", "5", "6", "7", "8" }));
...
//        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cpu/untitled1.png"))); // NOI18N
        jLabel14.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        jLabel14.setText("There was an image here");

//        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cpu/untitled3.png"))); // NOI18N
        jLabel15.setText("There was an image here");
